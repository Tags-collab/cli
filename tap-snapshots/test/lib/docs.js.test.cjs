...
* Default:
  "/Users/wraithgar/Development/npm/cli/branches/gar_node-gyp-config/node_modules/node-gyp/bin/node-gyp.js"
* Type: Path

This is the location of the "node-gyp" bin. By default it uses one that
ships with npm itself.

You can use this config to specify your own "node-gyp" to run.
